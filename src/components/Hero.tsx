...
const Hero: React.FC = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-br from-indigo-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              A passionate and results-driven Full Stack Developer with experience building 
              scalable web and mobile applications using ReactJS, React Native, and Node.js.
            </motion.p>
          ...
          >
            ...
            <div className="absolute -z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full bg-gradient-to-r from-indigo-300 to-indigo-500 dark:from-indigo-800 dark:to-indigo-600 -bottom-4 -right-4 animate-float" style={{ animationDelay: '-3s' }} />
          </motion.div>
        </div>
        ...
        >
          <a href="#about" aria-label="Scroll down">
            <ArrowDown className="text-indigo-600 dark:text-indigo-400" size={28} />
          </a>
        </motion.div>
      </div>
    </section>
